...
{
    public class CountriesController : IIKI.GoRoomy.WebApp.Controllers.WebAppBaseController
    {
        // GET: Admin/Country
        ...
        private Country GetAddEditObject(Country obj)
        {
        ...
        public ActionResult AddEdit(Country oObject, string formaction = "save")
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (oObject.Id > 0)
                        CountryBAL.Update(oObject);
                    else
                        CountryBAL.Add(oObject);
        ...
        public ActionResult DeleteRecord(long DeleteRecordId)
        {
            try
            {
                var obj = CountryBAL.Get(DeleteRecordId);
                CountryBAL.Delete(obj);
                return RedirectToAction("Index");
